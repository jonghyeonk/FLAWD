...
EL_polluted, top_stats = CollateralEvent(EL, 
                    target_collats = "[Activity:'O_SENT_BACK'>>('O_SENT_BACK1', 'O_SENT_BACK2')]",
                    # target_collats = "[Activity:'O_DECLINED'>>('O_DECLINED1', 'O_DECLINED2')]",
                    ratio= float(rate), 
                    timep = 1,
                    unit = 'sec',
                    case_id_key = "Case",
...
print(output)
with open('summary_CollateralEvent_high.csv', 'a', encoding='utf-8', newline='') as csvfile:
