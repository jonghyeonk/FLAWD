...
EL_polluted = SynonymousLabel(EL, 
                            target = "[Activity:('A_DECLINED')]",
                            syns = ["A_DECLINED - Dep1",  "A_DECLINED - Dep2", "A_DECLINED - Dep3"],
                            prob = [0.1, 0.6, 0.3],
                            ratio = float(rate),
                            case_id_key = "Case",
...
with open('summary_Synonymouslabel.csv', 'a', encoding='utf-8', newline='') as csvfile:
